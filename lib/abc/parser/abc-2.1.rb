...
module ABC
  ...
  def _nt_file_header
    ...
    if s0.last
      r0 = instantiate_node(HeaderNode,input, i0...index, s0)
      r0.extend(FileHeader1)
      r0.extend(FileHeader2)
    else
      @index = i0
      r0 = nil
    end
